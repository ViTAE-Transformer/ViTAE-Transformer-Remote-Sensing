...
parser.add_argument('--src', default='/public/data3/users/wangdi153/Dataset/isaid_dataset', type=str, help='path for the original dataset')
parser.add_argument('--tar', default='/public/data3/users/wangdi153/Dataset/isaid_patches', type=str, help='path for saving the new dataset')
