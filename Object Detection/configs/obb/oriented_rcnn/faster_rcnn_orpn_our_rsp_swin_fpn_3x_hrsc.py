...
model = dict(
    type='OrientedRCNN',
    pretrained='/public/data3/users/wangdi153/RS_CV/Swin-Transformer-main/output/swin_tiny_patch4_window7_224/epoch3000/swin_tiny_patch4_window7_224/default/ckpt.pth',
    backbone=dict(
        type='swin',
        embed_dim=96,
        depths=[2, 2, 6, 2],
